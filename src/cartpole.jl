# This is an example directly from the Altro package code for RoboticExplorationLab at 
# https://github.com/RoboticExplorationLab/Altro.jl/blob/main/examples/quickstart.jl.
# 
